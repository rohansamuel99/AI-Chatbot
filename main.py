...
if __name__ == "__main__":
    ...
    for every_station_name in test_data:
        ...
        station_name_train_data = picked_sentence.format(every_station_name)
        # Index of first character in string
        start_index = station_name_train_data.index(every_station_name)
        # Index of last character in string
        end_index = station_name_train_data.rfind(every_station_name[-1])
